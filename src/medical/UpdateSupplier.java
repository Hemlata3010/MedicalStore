...
String str1="UPDATE supplier SET sid='"+t1.getText()+"',sname='"+t2.getText()+"',saddress='"+t3.getText()+"',phoneno='"+t4.getText()+"',semailid='"+t5.getText()+"' where sid='"+t1.getText()+"' or sname='"+t2.getText()+"' ";
