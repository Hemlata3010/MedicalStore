...
public class AddNewMedicine extends JFrame implements ActionListener
{
 ...
 ps=con.prepareStatement("insert into medicine (m_bno,m_name,m_company,m_quantity,m_expdate,m_purdate,m_type,m_purprice,m_saleprice,m_rackno,m_sid,m_sname)values(?,?,?,?,?,?,?,?,?,?,?,?)");
