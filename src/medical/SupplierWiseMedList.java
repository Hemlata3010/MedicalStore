   ...
   jf.setLayout(null);
	...
	if(ae.getSource()==submit)
     ...
     try
     {
        ...
        rs = stmt.executeQuery("SELECT m_bno,m_name,m_company,m_quantity,m_expdate,m_purdate,m_type,m_purprice,m_saleprice,m_rackno,m_sid,m_sname from medicine where m_sname='"+t1.getText()+"' ");
          while(rs.next())
            {
