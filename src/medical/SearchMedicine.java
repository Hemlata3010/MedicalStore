...
public class SearchMedicine extends JFrame implements ActionListener
{
   ...
   //     l1.setForeground(new java.awt.Color(0,204,51));
     ...
     //   l5.setForeground(new java.awt.Color(0,204,51));
		...
		l4.setFont(f);
        l4.setBounds(50,300,250,25);
    //    l6.setForeground(new java.awt.Color(0,204,51));
    	jf.add(l4);

        t4= new JTextField(20);
		t4.setBounds(250,300,100,25);
		jf.add(t4);
